...
package com.eeda123.wedding.order;
...
import com.eeda123.wedding.model.AliexpressOrderItemArrayAdapter;
import com.eeda123.wedding.model.AliexpressOrderItemModel;
...
public class AliexpressOrderFragment extends ListFragment   implements SwipeRefreshLayout.OnRefreshListener{
    public static final String TAG = "retrofit2 Call";
    private boolean isRefresh = false;//是否刷新中
    private SwipeRefreshLayout mSwipeLayout;

    private AliexpressOrderItemModel[] models = new AliexpressOrderItemModel[0];
    private ArrayAdapter<AliexpressOrderItemModel> adapter = null;

    public static AliexpressOrderFragment newInstance() {
        AliexpressOrderFragment fragment = new AliexpressOrderFragment();
        return fragment;
    }
    ...
    private Callback<HashMap<String,Object>> eedaCallback() {
        return new Callback<HashMap<String,Object>>() {
            ...
            public void onResponse(Call<HashMap<String,Object>> call, Response<HashMap<String,Object>> response) {
                ...
                models = new AliexpressOrderItemModel[recList.size()];
                int index = 0;
                for(Map<String, Object> rec: recList){
                    AliexpressOrderItemModel model = new AliexpressOrderItemModel("aliexpress",
                ...
                adapter = new AliexpressOrderItemArrayAdapter(getActivity(), models);
