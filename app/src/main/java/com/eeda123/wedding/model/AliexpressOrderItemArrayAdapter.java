...
public class AliexpressOrderItemArrayAdapter extends ArrayAdapter<AliexpressOrderItemModel> {
    private final Activity context;
    private final AliexpressOrderItemModel[] models;
    ...
    public AliexpressOrderItemArrayAdapter(Activity context, AliexpressOrderItemModel[] models) {
        super(context, R.layout.aliexpress_order_list_item, models);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            rowView = inflater.inflate(R.layout.aliexpress_order_list_item, null);
        ...
        // fill data
        AliexpressOrderItemModel s = models[position];
        if (null != s) {
